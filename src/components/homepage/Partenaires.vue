  ...
  <div
    ...
    <a href="https://cap.marche.be/" class="">
      <img src="https://visitmarche.be/wp-content/themes/visitmarche/assets/tartine/rsc/img/img_sponsor02.png"
           title="Famenne Ardenne"
           alt="famenne ardenne" class="h-16 grayscale hover:grayscale-0"/>
    </a>
    <a href="http://www.paysdefamenne.be/" class="">
      <img src="https://visitmarche.be/wp-content/themes/visitmarche/assets/tartine/rsc/img/img_sponsor03.png"
           alt="cap commerçants" class="h-16 grayscale hover:grayscale-0"/>
    </a>
    <a href="https://www.marche.be/economie" class="">
      <img src="https://visitmarche.be/wp-content/themes/visitmarche/assets/tartine/rsc/img/img_sponsor04.png"
           alt="mcfa" class="h-16 grayscale hover:grayscale-0"/>
    </a>
    <a href="http://mcfa.marche.be/" class="">
      <img src="https://visitmarche.be/wp-content/themes/visitmarche/assets/tartine/rsc/img/img_sponsor05.png"
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <li style="scroll-snap-align: start;" class="w-1/3 flex-shrink-0 flex flex-col items-center justify-center p-2"
            role="option">
