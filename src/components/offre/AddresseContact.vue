...
<template>
  <div
      class="col-12 col-md-5 d-flex flex-column flex-ls-row flex-ls-wrap py-24px px-48px px-ls-12px align-self-stretch align-items-ls-start ml-auto bg-pastel">

    <!--address-->
    <div class="text-default col-ls-6 px-ls-12px col-ls-md-12">
      <h4 class="ff-semibold fs-short-1">Addresse</h4>
